...
struct Loan: Codable {
    ...
    // for the initializer, I set the default paymentsPerPeriod to 12. I'm not great with initializers though
    init(principal: Double, years: Double, rate: Double, downPayment: Double?, paymentsPerPeriod: Double = 12, additionalPrincipal: Double?) {
